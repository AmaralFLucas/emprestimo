...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.btn_consultar_relatorio.clicked.connect(self.consultar_periodo)
    ...
    def adicionar_emprestimo(self):
        ...
        # self.emprestimo_dialog.finished.connect(self.onemprestimo_closed)
        # self.hide()
...
class EmprestimoDialog(QDialog, Ui_Dialog):
    def __init__(self, parent=None):
        ...
        self.uniforme_service = UniformeService()
        self.emprestimo_service = EmprestimoService()
        self.main_window_service.populate_combo_uniforme(self)


        self.pushButton.clicked.connect(self.get_funcionario)
        self.btn_confirmar_emprestimo.clicked.connect(self.set_emprestimo)
