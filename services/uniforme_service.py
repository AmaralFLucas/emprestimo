...
class UniformeService:
    ...
    def update_uniforme(self, main_window):
        if main_window.btn_editar_uniforme.text() == 'Editar':
            selected_rows = main_window.tb_uniforme.selectionModel().selectedRows()
            if not selected_rows:
                return
            selected_row = selected_rows[0].row()
            main_window.txt_nome_uniforme.setText(main_window.tb_uniforme.item(selected_row, 0).text())
            self.uniforme_to_update = self.uniforme_repository.select_uniforme_by_name(main_window.tb_uniforme.
                                                                                  item(selected_row, 0).text())
            ...
            try:
                ...
                QMessageBox.warning(main_window, 'Uniformes', f'Erro ao atualizar o uniforme.\nErro: {e}')
    ...
    def delete_uniforme(self, main_window):
        ...
        self.uniforme_to_update = (self.uniforme_repository.select_uniforme_by_name
                                   (main_window.tb_uniforme.item(selected_row, 0).text()))
        ...
        if msg_box.clickedButton() == yes_button:
            try:
                ...
                QMessageBox.warning(main_window, 'Uniformes', f'Erro ao remover o uniforme.\nErro: {e}')